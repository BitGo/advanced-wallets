...
describe('Ecdsa Signing Handler', () => {
  ...
  const awmUrl = 'http://advanced-wallet-manager.invalid';
  ...
  it('should successfully sign an ECDSA MPCv2 transaction', async () => {
    ...
    const signMpcV2Round1NockAwm = nock(awmUrl)
    ...
    const signMpcV2Round2NockAwm = nock(awmUrl)
    ...
    const signMpcV2Round3NockAwm = nock(awmUrl)
