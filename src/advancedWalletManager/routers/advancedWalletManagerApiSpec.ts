...
export type AdvancedWalletManagerApiSpecRouteHandler<
...
export type AdvancedWalletManagerApiSpecRouteRequest<
  ApiName extends keyof typeof AdvancedWalletManagerApiSpec,
  Method extends keyof (typeof AdvancedWalletManagerApiSpec)[ApiName] & HttpMethod,
> = BitGoRequest<AdvancedWalletManagerConfig> &
  Parameters<AdvancedWalletManagerApiSpecRouteHandler<ApiName, Method>>[0];

export type GenericAdvancedWalletManagerApiSpecRouteRequest =
  AdvancedWalletManagerApiSpecRouteRequest<any, any>;
...
export function createKeyGenRouter(
  ...
  router.post('v1.key.independent', [
    responseHandler<AdvancedWalletManagerConfig>(async (req) => {
      const typedReq = req as AdvancedWalletManagerApiSpecRouteRequest<
        'v1.key.independent',
        'post'
      >;
  ...
  router.post('v1.multisig.sign', [
    responseHandler<AdvancedWalletManagerConfig>(async (req) => {
      const typedReq = req as AdvancedWalletManagerApiSpecRouteRequest<'v1.multisig.sign', 'post'>;
  ...
  router.post('v1.mpc.sign', [
    responseHandler<AdvancedWalletManagerConfig>(async (req) => {
      const typedReq = req as AdvancedWalletManagerApiSpecRouteRequest<'v1.mpc.sign', 'post'>;
  ...
  router.post('v1.mpc.recovery', [
    responseHandler<AdvancedWalletManagerConfig>(async (req) => {
      const typedReq = req as AdvancedWalletManagerApiSpecRouteRequest<'v1.mpc.recovery', 'post'>;
  ...
  router.post('v1.mpc.key.initialize', [
    responseHandler<AdvancedWalletManagerConfig>(async (_req) => {
      try {
        const typedReq = _req as AdvancedWalletManagerApiSpecRouteRequest<
          'v1.mpc.key.initialize',
          'post'
        >;
  ...
  router.post('v1.mpcv2.round', [
    responseHandler<AdvancedWalletManagerConfig>(async (req) => {
      const typedReq = req as AdvancedWalletManagerApiSpecRouteRequest<'v1.mpcv2.round', 'post'>;
  ...
  router.post('v1.mpcv2.finalize', [
    responseHandler<AdvancedWalletManagerConfig>(async (req) => {
      const typedReq = req as AdvancedWalletManagerApiSpecRouteRequest<'v1.mpcv2.finalize', 'post'>;
  ...
  router.post('v1.mpcv2.recovery', [
    responseHandler<AdvancedWalletManagerConfig>(async (req) => {
      const typedReq = req as AdvancedWalletManagerApiSpecRouteRequest<'v1.mpcv2.recovery', 'post'>;
