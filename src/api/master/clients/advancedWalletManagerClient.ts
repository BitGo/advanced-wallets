...
const debugLogger = debug('bitgo:masterExpress:advancedWalletManagerClient');
...
export class AdvancedWalletManagerClient {
  ...
  constructor(cfg: MasterExpressConfig, coin?: string) {
    if (!cfg.advancedWalletManagerUrl || !cfg.advancedWalletManagerCert) {
    ...
    debugLogger('AdvancedWalletManagerClient initialized with URL: %s', this.baseUrl);
  }
 ...
 */
export function createAdvancedWalletManagerClient(
